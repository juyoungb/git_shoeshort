...
<br />
<div align="center">
<form name="frm" action="adStoreIn" >
<input type="hidden" name="aiidx" value="<%=loginInfo.getAi_idx() %>" />
...
<td align="left"><input type="text" name="brand" value="" class="form-control" /></td>
