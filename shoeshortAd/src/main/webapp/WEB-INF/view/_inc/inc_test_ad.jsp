...
<body>
  <div class="sidebar close">
    <div class="logo-details">
      ...
      <span class="logo_name">관리자님</span>
    </div>
    <ul class="nav-links">
      <li>
        <div class="iocn-link">
        ...
        <ul class="sub-menu">
          <li><a class="link_name" href="#">회원 관리</a></li>
      ...
      <li>
        ...
        <ul class="sub-menu">
          <li><a class="link_name" href="#">주문 관리</a></li>
      ...
      <li>
        ...
        <ul class="sub-menu blank">
          <li><a class="link_name" href="#">메인 관리</a></li>
        </ul>
      </li>
      <li>
        <a href="#">
        ...
        <ul class="sub-menu blank">
        <% if (isLogin) { %>
          <li><a class="link_name" href="loginSpr">logout</a></li>
        <% } %>
        </ul>
      </li>
      <li>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="text">ShoeShort</span>
    </div>
