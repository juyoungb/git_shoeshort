...
<td width="5%">
	<input type="checkbox" name="chk" value="<%=ocidx %>"checked="checked" onclick="chkOne(this)"/>
</td>
<td width="15%">
...
<p align="right" style="width:800px; font-size:1.8em;">총 구매 금액: <%=total %></p>
<p align="center" style="width:800px; font-size:1.3em;">
	...
	<input type="button" value="전체 상품 삭제" onclick="allBuy()" />	
</p>

<%} else {	//장바구니에 담긴 상품이 없을 경우 %>
<p align="right" style="width:800px; text-align:center;">장바구니에 담긴 상품이 없습니다.</p>
<%} %>
</form>
</body>
</html> --%>