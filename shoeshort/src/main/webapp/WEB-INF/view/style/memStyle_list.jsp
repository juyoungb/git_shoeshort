...
List<StyleInfo> memStyle = (List<StyleInfo>)request.getAttribute("memStyle");
...
<meta name="theme-color" content="#712cf9">
  ...
  <body>
<div id="tmp">
<div><h2 align="center"><%=miid %>님의 STYLE</h2></div>
...
<%
	int i = 0;
	for(i = 0;i < memStyle.size();i++) {
		StyleInfo si = memStyle.get(i);
%>
        <div class="col">
...
<% 
if (rcnt > 0) {
	String link = "memStyle?1=1&cpage=";
%>
