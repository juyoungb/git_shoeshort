...
public class MemberAddr {
	...
	public void getAll() {
		System.out.println(getMa_idx());
		System.out.println(getMi_id());
		System.out.println(getMa_name());
		System.out.println(getMa_rname());
		System.out.println(getMa_phone());
		System.out.println(getMa_zip());
		System.out.println(getMa_addr1());
		System.out.println(getMa_addr2());
		System.out.println(getMa_basic());
		System.out.println(getMa_date());
	}	
}
